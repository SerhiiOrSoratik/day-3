...
function _constants() {
  const data = _interopRequireDefault(require('jest-haste-map/build/constants'));
...
function fastPath() {
  const data = _interopRequireWildcard(require('jest-haste-map/build/lib/fast_path'));
...
function _normalizePathSep() {
  const data = _interopRequireDefault(require('jest-haste-map/build/lib/normalizePathSep'));
