...
var _HasteFS = _interopRequireDefault(require('jest-haste-map/build/HasteFS'));

var _ModuleMap = _interopRequireDefault(require('jest-haste-map/build/ModuleMap'));

var _constants = _interopRequireDefault(require('jest-haste-map/build/constants'));

var _node = _interopRequireDefault(require('jest-haste-map/build/crawlers/node'));

var _watchman = _interopRequireDefault(require('jest-haste-map/build/crawlers/watchman'));

var _getMockName = _interopRequireDefault(require('jest-haste-map/build/getMockName'));

var fastPath = _interopRequireWildcard(require('jest-haste-map/build/lib/fast_path'));

var _getPlatformExtension = _interopRequireDefault(
  require('jest-haste-map/build/lib/getPlatformExtension')
);

var _normalizePathSep = _interopRequireDefault(
  require('jest-haste-map/build/lib/normalizePathSep')
);

var _FSEventsWatcher = _interopRequireDefault(
  require('jest-haste-map/build/watchers/FSEventsWatcher')
);

var _NodeWatcher = _interopRequireDefault(require('jest-haste-map/build/watchers/NodeWatcher'));

var _WatchmanWatcher = _interopRequireDefault(
  require('jest-haste-map/build/watchers/WatchmanWatcher')
);

var _worker = require('jest-haste-map/build/worker');
...
// understand `require`.
const {version: VERSION} = require('jest-haste-map/package.json');
