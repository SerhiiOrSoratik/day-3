...
const SummaryTableHeader = require('istanbul-reports/lib/html-spa/src/summaryTableHeader');
const SummaryTableLine = require('istanbul-reports/lib/html-spa/src/summaryTableLine');
const SummaryHeader = require('istanbul-reports/lib/html-spa/src/summaryHeader');
const getChildData = require('istanbul-reports/lib/html-spa/src/getChildData');
const FlattenToggle = require('istanbul-reports/lib/html-spa/src/flattenToggle');
const FilterToggle = require('istanbul-reports/lib/html-spa/src/filterToggle');
const FileBreadcrumbs = require('istanbul-reports/lib/html-spa/src/fileBreadcrumbs');
const { setLocation, decodeLocation } = require('istanbul-reports/lib/html-spa/src/routing');
