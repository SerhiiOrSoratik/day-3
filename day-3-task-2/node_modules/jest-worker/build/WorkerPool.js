...
var _BaseWorkerPool = _interopRequireDefault(require('jest-worker/build/base/BaseWorkerPool'));
...
class WorkerPool extends _BaseWorkerPool.default {
  ...
  createWorker(workerOptions) {
    ...
    if (this._options.enableWorkerThreads && canUseWorkerThreads()) {
      Worker = require('jest-worker/build/workers/NodeThreadsWorker').default;
    } else {
      Worker = require('jest-worker/build/workers/ChildProcessWorker').default;
    }
