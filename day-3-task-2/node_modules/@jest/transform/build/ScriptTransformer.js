...
var _enhanceUnexpectedTokenMessage = _interopRequireDefault(
  require('@jest/transform/build/enhanceUnexpectedTokenMessage')
);

var _shouldInstrument = _interopRequireDefault(require('@jest/transform/build/shouldInstrument'));
...
const {version: VERSION} = require('@jest/transform/package.json');
