...
function _TestWatcher() {
  const data = _interopRequireDefault(require('@jest/core/build/TestWatcher'));
...
function _collectHandles() {
  const data = require('@jest/core/build/collectHandles');
...
function _getChangedFilesPromise() {
  const data = _interopRequireDefault(require('@jest/core/build/getChangedFilesPromise'));
...
function _getConfigsOfProjectsToRun() {
  const data = _interopRequireDefault(require('@jest/core/build/getConfigsOfProjectsToRun'));
...
function _getProjectNamesMissingWarning() {
  const data = _interopRequireDefault(
    require('@jest/core/build/getProjectNamesMissingWarning')
  );
...
function _getSelectProjectsMessage() {
  const data = _interopRequireDefault(require('@jest/core/build/getSelectProjectsMessage'));
...
function _createContext() {
  const data = _interopRequireDefault(require('@jest/core/build/lib/createContext'));
...
function _handleDeprecationWarnings() {
  const data = _interopRequireDefault(
    require('@jest/core/build/lib/handleDeprecationWarnings')
  );
...
function _logDebugMessages() {
  const data = _interopRequireDefault(require('@jest/core/build/lib/logDebugMessages'));
...
function _pluralize() {
  const data = _interopRequireDefault(require('@jest/core/build/pluralize'));
...
function _runJest() {
  const data = _interopRequireDefault(require('@jest/core/build/runJest'));
...
function _watch() {
  const data = _interopRequireDefault(require('@jest/core/build/watch'));
