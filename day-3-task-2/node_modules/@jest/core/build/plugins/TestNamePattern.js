...
function _TestNamePatternPrompt() {
  const data = _interopRequireDefault(require('@jest/core/build/TestNamePatternPrompt'));
...
function _activeFiltersMessage() {
  const data = _interopRequireDefault(require('@jest/core/build/lib/activeFiltersMessage'));
