...
const serializationAdapter = require("jsdom/lib/jsdom/living/domparsing/parse5-adapter-serialization");
const {
  customElementReactionsStack, invokeCEReactions, lookupCEDefinition
} = require("jsdom/lib/jsdom/living/helpers/custom-elements");
