...
const { compareBoundaryPointsPosition } = require("jsdom/lib/jsdom/living/range/boundary-point");
const { nodeRoot, nodeLength, isInclusiveAncestor } = require("jsdom/lib/jsdom/living/helpers/node");
const { createElement } = require("jsdom/lib/jsdom/living/helpers/create-element");

const AbstractRangeImpl = require("jsdom/lib/jsdom/living/range/AbstractRange-impl").implementation;
