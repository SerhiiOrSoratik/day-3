...
const { fragmentSerialization } = require("jsdom/lib/jsdom/living/domparsing/serialization");
...
const { asciiLowercase, asciiUppercase } = require("jsdom/lib/jsdom/living/helpers/strings");
...
const SlotableMixinImpl = require("jsdom/lib/jsdom/living/nodes/Slotable-impl").implementation;
...
const { isValidHostElementName } = require("jsdom/lib/jsdom/living/helpers/shadow-dom");
const { isValidCustomElementName, lookupCEDefinition } = require("jsdom/lib/jsdom/living/helpers/custom-elements");
