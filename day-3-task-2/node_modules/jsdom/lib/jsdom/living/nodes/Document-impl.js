...
const { hasWeakRefs, mixin, memoizeQuery } = require("jsdom/lib/jsdom/utils");
...
const StyleSheetList = require("jsdom/lib/jsdom/living/generated/StyleSheetList.js");
...
const { shadowIncludingInclusiveDescendantsIterator } = require("jsdom/lib/jsdom/living/helpers/shadow-dom");
const { enqueueCECallbackReaction } = require("jsdom/lib/jsdom/living/helpers/custom-elements");
const { createElement, internalCreateElementNSSteps } = require("jsdom/lib/jsdom/living/helpers/create-element");
const IterableWeakSet = require("jsdom/lib/jsdom/living/helpers/iterable-weak-set");
...
const ShadowRoot = require("jsdom/lib/jsdom/living/generated/ShadowRoot");
const Range = require("jsdom/lib/jsdom/living/generated/Range");
const documents = require("jsdom/lib/jsdom/living/documents.js");
...
const RequestManager = require("jsdom/lib/jsdom/browser/resources/request-manager");
const AsyncResourceQueue = require("jsdom/lib/jsdom/browser/resources/async-resource-queue");
const ResourceQueue = require("jsdom/lib/jsdom/browser/resources/resource-queue");
const PerDocumentResourceLoader = require("jsdom/lib/jsdom/browser/resources/per-document-resource-loader");
