...
const { getHTMLElementInterface } = require("jsdom/lib/jsdom/living/helpers/create-element");
const { shadowIncludingInclusiveDescendantsIterator } = require("jsdom/lib/jsdom/living/helpers/shadow-dom");
const { isValidCustomElementName, tryUpgradeElement, enqueueCEUpgradeReaction } = require("jsdom/lib/jsdom/living/helpers/custom-elements");

const idlUtils = require("jsdom/lib/jsdom/living/generated/utils");
const IDLFunction = require("jsdom/lib/jsdom/living/generated/Function.js");
