...
const percent = require('istanbul-lib-coverage/lib/percent');
const dataProperties = require('istanbul-lib-coverage/lib/data-properties');
const { CoverageSummary } = require('istanbul-lib-coverage/lib/coverage-summary');
